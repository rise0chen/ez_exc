...
impl From<(OrderSide, exc_util::types::order::OrderType)> for OrderType {
    fn from(value: (OrderSide, exc_util::types::order::OrderType)) -> Self {
        match value {
            ...
            (OrderSide::Buy | OrderSide::CloseSell, exc_util::types::order::OrderType::Market) => Self::BuyIoc,
            ...
            (OrderSide::Sell | OrderSide::CloseBuy, exc_util::types::order::OrderType::Market) => Self::SellIoc,
