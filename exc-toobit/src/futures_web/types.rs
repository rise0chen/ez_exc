...
impl From<OrderSide> for exc_util::types::order::OrderSide {
    fn from(value: OrderSide) -> Self {
        match value {
            ...
            OrderSide::BuyOpen => Self::Buy,
            OrderSide::SellClose => Self::CloseSell,
            OrderSide::BuyClose => Self::CloseBuy,
            OrderSide::SellOpen => Self::Sell,
        }
    }
}
...
impl From<exc_util::types::order::OrderType> for TimeInForce {
    fn from(value: exc_util::types::order::OrderType) -> Self {
        match value {
            ...
            exc_util::types::order::OrderType::LimitMaker => Self::Maker,
