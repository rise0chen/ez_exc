...
async fn main() -> anyhow::Result<()> {
    ...
    let order_req = PlaceOrderRequest::new(0.001, 80000.0, OrderType::Limit);
    let order_id = bybit.place_order(&symbol, order_req).await.unwrap_or_else(|(o, _e)| o);
    ...
    let mut order_req = PlaceOrderRequest::new(0.001, 80000.0, OrderType::Limit);
